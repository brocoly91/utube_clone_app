...
class YoutubeRepository extends GetConnect{
  ...
  Future<YoutubeVideoResult?> loadVideos(String nextPageToken) async {
    ...
    String url =
        "/youtube/v3/search?part=snippet&channelId=UCFs3fyPkiaN9bGgHqMTyjaA&maxResults=10&order=date&type=video&videoDefinition=high&key=AIzaSyBRQWat0h2wtDGdodY-G0NsijWlD4cIHso&pageToken=$nextPageToken";
